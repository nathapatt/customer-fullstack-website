    ...
    const createSession = async () => {
      ...
      try {
        ...
        setSession(session.id, {
          ...session,
          expiresAt: session.expiresAt === null ? undefined : session.expiresAt,
        });
      ...
      <div className="text-center p-6">
        ...
        {sessionMessage && (
          ...
          >
            ...
            >
              {sessionMessage.includes("Joined") &&
                "👥 คุณได้เข้าร่วมโต๊ะที่มีผู้อื่นสั่งอาหารอยู่แล้ว"}
              {sessionMessage.includes("expired") &&
                "⏰ เซสชันเก่าหมดอายุแล้ว สร้างเซสชันใหม่"}
              {sessionMessage.includes("New session created") &&
        ...
        {tableInfo && (
          <div className="bg-white rounded-lg p-4 mb-4 shadow-sm">
            ...
            <p className="text-gray-600">
              โต๊ะหมายเลข: A-{tableInfo.tableNumber}
            </p>
            <p className="text-gray-600">
              จำนวนที่นั่ง: {tableInfo.capacity} ที่
            </p>
          </div>
        )}
