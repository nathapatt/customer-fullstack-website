...
const FoodDetailPage = () => {
  ...
  // ข้อมูลอาหาร
  const foodItem = state.menuItems.find(
  ...
  return (
    <div className="max-w-md mx-auto bg-white min-h-screen flex flex-col animate-slideUpFromBottom">
      {/* Header Image */}
      ...
      <div className="px-4 py-4 flex-1 flex flex-col">
        ...
        <div className="mb-6">
          ...
          <p className="text-base text-gray-600 mb-2">{foodItem.description}</p>
        ...
        <div className="mt-auto">
          ...
          <button
            onClick={() => {
              const cartItem = { ...foodItem, quantity, note };
              addToCart(cartItem);
              navigate("/");
            }}
